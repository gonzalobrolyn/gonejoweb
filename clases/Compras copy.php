...
<?php
   ...
   class compras{
      ...
      public function registraDeposito($datos){
         ...
         $sqlMovimi = "INSERT into movimiento (
                                movimiento_nombre,
                                movimiento_estado,
                                movimiento_persona,
                                movimiento_efectivo,
                        ...
                        values ('$datos[0]',
                                ...
                                '$idPersona',
                                '$datos[8]')";
         $deposito = mysqli_query($conexion, $sqlMovimi);
         if ($deposito > 0) {
            $sqlCaja = "UPDATE caja
      ...
      public function crearCompra($movi){
         ...
         $sqlMovimi = "INSERT into movimi(
                        ...
                        values ('$movi[0]'
                                ...
                                '$idPersona',
                                '$idCaja')";
         $resCompra = mysqli_query($conexion, $sqlMovimi);
            ...
            $v3 = (($dAlma[1] * $dAlma[4]) + ($li[8] * $li[11]))/$n;
               ...
               $sqlActualiza = "UPDATE almacen
                                   set almacen_cantidad = '$n',
                                       almacen_preciollegada = '$v1',
                                       almacen_preciotraspaso = '$v2',
                                       almacen_precioventa = '$v3'
